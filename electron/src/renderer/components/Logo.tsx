...
export function Logo({ className, variant = 'color', title = 'Sortie' }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      <g fill="none" strokeWidth={48} strokeLinejoin="round" strokeLinecap="round">
        <path d="M 312 450 A 240 240 0 0 1 792 450 L 792 830 L 312 830 Z" stroke="#C9B8E8" />
        <path d="M 262 420 A 240 240 0 0 1 742 420 L 742 800 L 262 800 Z" stroke="#F4A896" />
        <circle cx={502} cy={500} r={80} stroke="#8BD4B8" />
        <path
